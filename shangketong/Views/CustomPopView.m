...
- (void)show {
    ...
    [self setX:kScreen_Width - CGRectGetWidth(self.bounds) - 10 + (0.5 - 20.0 / CGRectGetWidth(self.bounds)) * CGRectGetWidth(self.bounds)];
...
- (void)configViewFrame {
    [self setHeight:_titleArray.count * [CustomPopCell cellHeight] + kArrowHeight];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [CustomPopCell cellHeight];
}
