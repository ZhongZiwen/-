...
@interface PhotoZoomingImageView ()<UIScrollViewDelegate>

@property (strong, readwrite, nonatomic) UIScrollView *scrollView;
@property (nonatomic, strong) UIView *containerView;
@end

@implementation PhotoZoomingImageView
...
- (void)handleLongPress:(UILongPressGestureRecognizer*)sender {
    ...
    if (sender.state == UIGestureRecognizerStateBegan) {
        ...
        actionSheet.sourceArray = @[@"保存图片"];
        actionSheet.actionType = ActionSheetTypeFromOther;
        actionSheet.selectedBlock = ^(NSNumber *index, ActionSheetTypeFrom typeFrom) {
...
- (void)setUrl:(NSString *)url {
    ...
    [[SDWebImageManager sharedManager] downloadImageWithURL:[NSURL URLWithString:url] options:SDWebImageRetryFailed| SDWebImageLowPriority| SDWebImageHandleCookies progress:^(NSInteger receivedSize, NSInteger expectedSize) {
