//
//  ReportToServiceViewController.m
//  shangketong
//
//  Created by sungoin-zjp on15-12-29.
...
@interface ReportToServiceViewController ()<UITextViewDelegate,UIAlertViewDelegate>{
    UITextView *textviewFeedback;
}

@end

@implementation ReportToServiceViewController
...
-(void)sendCmd{
    ...
    // 发起请求
    [AFNHttp post:[NSString stringWithFormat:@"%@%@",MOBILE_SERVER_IP_OA, REPORT_TO_SERVICE_ACTION] params:params success:^(id responseObj) {
        [hud hide:YES];
