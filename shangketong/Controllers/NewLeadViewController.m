...
static NSString *const kHighSea = @"highSea";
static NSString *const kBelongDepartment = @"belongDepartment";

@interface NewLeadViewController ()
...
- (void)viewDidLoad {
    ...
    // 公海信息
    section = [XLFormSectionDescriptor formSectionWithTitle:@"公海信息"];
    [form addFormSection:section];
    // 所属公海
    row = [XLFormRowDescriptor formRowDescriptorWithTag:kHighSea rowType:XLFormRowDescriptorTypeSelectorPush title:@"所属公海"];
    row.value = [XLFormOptionsObject formOptionsObjectWithValue:@(-1) displayText:@"必填"];
    row.selectorTitle = @"所属公海";
    row.selectorOptions = @[[XLFormOptionsObject formOptionsObjectWithValue:@(0) displayText:@"默认分组"],
                            [XLFormOptionsObject formOptionsObjectWithValue:@(1) displayText:@"销售线索池1"],
                            [XLFormOptionsObject formOptionsObjectWithValue:@(2) displayText:@"销售线索池"],
                            [XLFormOptionsObject formOptionsObjectWithValue:@(3) displayText:@"市场线索"],
                            [XLFormOptionsObject formOptionsObjectWithValue:@(4) displayText:@"分组数据管理员"],
                            [XLFormOptionsObject formOptionsObjectWithValue:@(5) displayText:@"111"]];
    [section addFormRow:row];
...
- (void)addMoreButtonPress {
    ...
    __weak __block NewLeadViewController *copy_self = self;
