//
//  ScheduleAcceptMemberController.m
//  shangketong
//
...
#import "ScheduleAcceptMemberController.h"
...
@interface ScheduleAcceptMemberController ()<UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate>
...
@implementation ScheduleAcceptMemberController
...
//        if (i == 0) {
//            string = [NSString stringWithFormat:@"%d", selectItem.m_id];
//        }else {
//            string = [NSString stringWithFormat:@"%@,%d", string, selectItem.m_id];
//        }
    }
    ...
    [_scheduleSourceDict setObject:string forKey:@"addStaffIds"];
