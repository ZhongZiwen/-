...
@interface STTweetLabel () <UITextViewDelegate,UIGestureRecognizerDelegate>
...
- (void)setupLabel {
    ...
    self.textColor = [CommonStaticVar getContentColor];
    
    _attributesText = @{NSForegroundColorAttributeName: self.textColor, NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:[CommonStaticVar getContentFontSize]]};
    _attributesHandle = @{NSForegroundColorAttributeName: LIGHT_BLUE_COLOR, NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:[CommonStaticVar getContentFontSize]]};
    ...
    _attributesLink = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:129.0/255.0 green:171.0/255.0 blue:193.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:FONT_WORKGROUP_CONTENT_SIZE]};
