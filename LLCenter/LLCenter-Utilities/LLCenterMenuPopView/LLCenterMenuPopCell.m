...
- (void)configWithTitle:(NSString *)title andImageName:(NSString *)imageName {
    ...
    [_m_titleLabel setWidth:[title getWidthWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(MAXFLOAT, 20)]];
//    [_m_titleLabel setWidth:120];
...
//        _m_titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, 0, CGRectGetHeight(self.bounds))];
        _m_titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 0, 0, CGRectGetHeight(self.bounds))];
...
//        _m_imageView = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - 35, ([CustomPopCell cellHeight] - 20) / 2.0, 20, 20)];
        _m_imageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, ([LLCenterMenuPopCell cellHeight] - 20) / 2.0, 20, 20)];
    }
    return _m_imageView;
}
